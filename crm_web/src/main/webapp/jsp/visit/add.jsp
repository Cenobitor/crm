					...
					<td vAlign=top width="100%" bgcolor="#ffffff">
						...
						<table cellspacing="0" cellpadding="5" border="0">
							<tr>
								<td>客户名称：</td>
								<td>
									<select name="visit_cust.cust_id" onchange="changeCustomer()" id="customer" class="textbox" style="width: 180px; height: 21px;">
							...
							<tr>
								<td>被拜访人：</td>
								<td>
									<select name="visit_lkm.lkm_id"  id="linkMan" class="textbox" style="width: 180px; height: 21px;">
			...
			<tbody>
				<tr>
					<td width="15"><img
						...
						border="0"></td>
					<td align="center" width="100%" background="${pageContext.request.contextPath}/images/new_025.jpg" height="15">
					</td>
					<td width="15">
