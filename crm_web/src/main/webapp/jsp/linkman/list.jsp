...
<head>
    ...
    <SCRIPT type="text/javascript">
        $(function(){
            var customerOldVal = "${customer.cust_id}";
            var genderOldVal = "${lkm_gender}"
            ...
            $.get(url , function(result){
                ...
                $("#customer").find("option[value="+customerOldVal+"]").prop("selected","selected");
                $("#lkm_gender").find("option[value="+genderOldVal+"]").prop("selected","selected");
            } , "json");
        });
        function del(id) {
            var flag = confirm("您确定要删除联系人?");
            if (flag){
                location.href="${pageContext.request.contextPath }/linkMan_del?lkm_id="+id;
            }
        }
        function edit(id) {
            location.href="${pageContext.request.contextPath }/linkMan_edit?lkm_id="+id;
        }
                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <td>性别 ：</td>
                                    <td>
                                        <select name="lkm_gender" class=textbox id="lkm_gender" style="WIDTH: 180px;height:21px">
                            ...
                            <TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
                                ...
                                <c:forEach items="${list }" var="linkman">
                                    <TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                                        ...
                                        <TD>
                                            <a href="javascript:edit(${linkman.lkm_id})">修改</a>
                                            &nbsp;&nbsp;
