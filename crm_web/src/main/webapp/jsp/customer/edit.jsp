...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/customer_updateCustomer" method=post enctype="multipart/form-data">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<tr>
								<td>企业资质:</td>
								<td>
									<input type="hidden" name="cust_image" value="${editCustomer.cust_image}"/>
